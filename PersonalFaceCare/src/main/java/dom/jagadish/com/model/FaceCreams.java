...
@Document(collection = "FaceCreams")
public class FaceCreams {
	...
	public FaceCreams(String productId, String productName, double productCost, String productDescription,
