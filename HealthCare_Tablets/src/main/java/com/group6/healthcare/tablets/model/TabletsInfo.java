package com.group6.healthcare.tablets.model;

import org.springframework.data.annotation.Id;
import org.springframework.data.mongodb.core.mapping.Document;

@Document(collection="Tablets")
public class TabletsInfo {
		...
		public TabletsInfo(String productId, String productName, double productCost, String productDescription,
